...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://bokepindocina.pages.dev/v/${file.filecode}#${file.title}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepindocina.pages.dev/v/${file.filecode}#${file.title}`
            }  
        }
        }
    return (
